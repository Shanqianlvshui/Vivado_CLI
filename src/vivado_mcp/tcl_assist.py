...
COMMAND_COVERAGE: dict[str, dict[str, object]] = {
    ...
    "open_hw_manager": {
        "coverage_status": "covered",
        "recommended_tools": ["vivado_hw_discover"],
        "recommendation": "prefer_structured_tool",
        "notes": "Use read-only hardware discovery for Hardware Manager access; the structured tool does not program devices.",
    },
    "connect_hw_server": {
        "coverage_status": "covered",
        "recommended_tools": ["vivado_hw_discover"],
        "recommendation": "prefer_structured_tool",
        "notes": "Use read-only hardware discovery with expect_hardware_access=true to connect to hw_server and list targets/devices.",
    },
    "open_hw_target": {
        "coverage_status": "covered",
        "recommended_tools": ["vivado_hw_discover"],
        "recommendation": "prefer_structured_tool",
        "notes": "Use read-only hardware discovery to open matching targets and capture target/device summaries.",
    },
    "get_hw_targets": {
        "coverage_status": "covered",
        "recommended_tools": ["vivado_hw_discover"],
        "recommendation": "prefer_structured_tool",
        "notes": "Use read-only hardware discovery to enumerate targets with summary artifacts.",
    },
    "get_hw_devices": {
        "coverage_status": "covered",
        "recommended_tools": ["vivado_hw_discover"],
        "recommendation": "prefer_structured_tool",
        "notes": "Use read-only hardware discovery to enumerate devices, common properties, and warnings.",
    },
    "refresh_hw_device": {
        "coverage_status": "partial",
        "recommended_tools": ["vivado_hw_discover", "vivado_review_tcl"],
        "recommendation": "prefer_structured_tool_when_possible",
        "notes": "Use vivado_hw_discover(refresh=true) for read-only refresh during discovery. Review expert Tcl for debug/probe flows.",
    },
    "program_hw_devices": {
        "coverage_status": "raw_tcl",
        "recommended_tools": ["vivado_review_tcl", "vivado_search_official_docs", "vivado_run_tcl"],
        "recommendation": "requires_explicit_user_approval_and_expert_tcl",
        "notes": "No structured programming tool exists. Review against UG908/UG835 and require expect_destructive=true for expert Tcl.",
    },
    "write_cfgmem": {
        "coverage_status": "raw_tcl",
        "recommended_tools": ["vivado_review_tcl", "vivado_search_official_docs", "vivado_run_tcl"],
        "recommendation": "requires_explicit_user_approval_and_expert_tcl",
        "notes": "No structured configuration-memory write tool exists. Review against UG908/UG835 and require expect_destructive=true for expert Tcl.",
    },
    "boot_hw_device": {
        "coverage_status": "raw_tcl",
        "recommended_tools": ["vivado_review_tcl", "vivado_search_official_docs", "vivado_run_tcl"],
        "recommendation": "requires_explicit_user_approval_and_expert_tcl",
        "notes": "No structured boot operation tool exists. Review against UG908/UG835 and require expect_destructive=true for expert Tcl.",
    },
    "read_verilog": {
        "coverage_status": "covered",
        "recommended_tools": ["vivado_nonproject_read_sources", "vivado_nonproject_audit"],
        "recommendation": "prefer_structured_tool",
        "notes": "Use structured Non-project read, preferably dry_run=true first for non-trivial scripts, then audit recorded inputs before synthesis.",
    },
    "read_vhdl": {
        "coverage_status": "covered",
        "recommended_tools": ["vivado_nonproject_read_sources", "vivado_nonproject_audit"],
    ...
    "read_xdc": {
        ...
        "recommended_tools": ["vivado_nonproject_read_sources", "vivado_nonproject_audit"],
        "recommendation": "prefer_structured_tool",
        "notes": "Use structured Non-project read so XDC paths are validated and summarized with the design sources; audit before synthesis.",
    },
    "synth_design": {
        "coverage_status": "covered",
        "recommended_tools": ["vivado_nonproject_audit", "vivado_nonproject_synth_design"],
        "recommendation": "prefer_structured_tool",
        "notes": "Audit current Non-project inputs first, then use structured synthesis with dry_run=true for the Tcl/checkpoint/report plan.",
    },
    "opt_design": {
        "coverage_status": "covered",
        "recommended_tools": ["vivado_nonproject_audit", "vivado_nonproject_opt_design"],
        "recommendation": "prefer_structured_tool",
        "notes": "Audit that synthesis has completed before structured optimization; dry-run shows checkpoints and requested reports.",
    },
    "place_design": {
        "coverage_status": "covered",
        "recommended_tools": ["vivado_nonproject_audit", "vivado_nonproject_place_design"],
        "recommendation": "prefer_structured_tool",
        "notes": "Audit that optimization has completed before structured placement; dry-run shows checkpoints and requested reports.",
    },
    "route_design": {
        "coverage_status": "covered",
        "recommended_tools": ["vivado_nonproject_audit", "vivado_nonproject_route_design"],
        "recommendation": "prefer_structured_tool",
        "notes": "Audit that placement has completed before structured routing; dry-run shows final checkpoint and report plan.",
    },
    "write_checkpoint": {
        "coverage_status": "covered",
        "recommended_tools": [
