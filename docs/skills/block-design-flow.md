...
5. Call `vivado_bd_apply` with generic actions such as `create_cell`, `create_port`, `connect_net`, `connect_interface_net`, `set_property`, `apply_automation`, `assign_address`, `validate`, or `save`.
